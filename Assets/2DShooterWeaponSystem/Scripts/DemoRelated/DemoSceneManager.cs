...
public class DemoSceneManager : MonoBehaviour
{
    ...
    public Slider bulletFrequencySlider;
    public Slider bulletAmplitudeSlider;
	...
	void Start ()
	{
	    ...
	    switch (loadedLevelName)
	    {
	        ...
	        case "SpaceTopDownDemoScene":
	            demoSceneText1.text = "Scroll the mouse wheel / D-Pad up/down to select different turrets on the space platform. Left click / space / GamePad (south) to shoot.";
    ...
    private void SetupAdvancedCustomisationControls()
    {
        ...
        bulletAmplitudeSlider?.onValueChanged.AddListener(AdvancedSliderBulletAmplitudeChangedHandler);
        bulletFrequencySlider?.onValueChanged.AddListener(AdvancedSliderBulletFrequencyChangedHandler);
    ...
    private void SetCurrentWeaponSystemValues()
    {
        ...
        bulletAmplitudeSlider.value = playerWeaponSystemRef.bulletAmplitude;
        bulletFrequencySlider.value = playerWeaponSystemRef.bulletFrequencyIncrement;

        if (circularRotationRateSlider != null)
        {
        ...
        if (circularFireModeToggle != null)
        {
    ...
    private void AdvancedSliderBulletAmplitudeChangedHandler(float value)
    {
        playerWeaponSystemRef.bulletAmplitude = value;
    }

    private void AdvancedSliderBulletFrequencyChangedHandler(float value)
    {
        playerWeaponSystemRef.bulletFrequencyIncrement = value;
    }
