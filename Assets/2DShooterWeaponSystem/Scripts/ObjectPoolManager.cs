...
public class ObjectPoolManager : MonoBehaviour {
    ...
    private GameObject GetDisabledPoolObject(List<GameObject> poolCollection)
    {
        for (var i = 0; i < poolCollection.Count; i++)
        {
            if (!poolCollection[i].activeSelf)
            {
                return poolCollection[i];
            }
        }
    ...
    {
        GameObject obj = GetDisabledPoolObject(standardHorizontalBulletObjectPool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(sphereBulletObjectPool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(turretBulletObjectPool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam1Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam2Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam3Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam4Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam5Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(beam6Pool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(sparkObjectPool);
    ...
    {
        GameObject obj = GetDisabledPoolObject(bloodObjectPool);
