...
public class WeaponSystem : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (input != null)
        {
            ...
            Debug.Log("handling input actions");
        }
    }
    ...
    private void HandleActions(InputAction.CallbackContext context)
    {
        ...
        switch (context.action.name)
        {
            ...
            case "Reload":
                if (!isReloading && usesMagazines && (magazineRemainingBullets < magazineSize) && (ammoUsed < startingAmmo))
                {
    ...
    private void ProcessBullets()
    {
        ...
        for (var i = 0; i < bulletCount; i++)
        {
            ...
            if (mirrorX)
            {
                ...
                var bulletMirroredComponent = (Bullet)bulletMirrored.GetComponent(typeof(Bullet));
